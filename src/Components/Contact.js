    ...
    <div className="container-fluid text-center mt-5 p-5 back">
      ...
      <div className="lead text-left p-4">
        ...
        <div className="p-2">
          ...
          H4/23/12, Milanpally, Durgapur - 713203, West Bengal
          <br></br>
        </div>
        <div className="p-2">
          <svg
        ...
        <div className="p-2">
          <svg
            ...
            height="1em"
            viewBox="0 0 16 16"
            class="bi bi-building text-success"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
          ...
          Office at 1/1 Dayananda Road ( School of Music), Durgapur - 713205
        </div>
      </div>
    </div>
  );
