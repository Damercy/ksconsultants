...
const experts = [
  ...
  },
  {
    ...
    picture: "",
    qualifications:
      "B Tech (Radio Physics & Electronics) ,B Sc ( Physics) , Former Dy. General Manager",
    description:
      "With more than 33 years of experience in Durgapur Steel Plant (SAIL), his area of works includes Project Management (Telecommunications), ERP implementations, TQM philosophy, Lead auditor in ISO 9001 & 14001. He is having a rich experience in 5S – Concept, QC & TQM philosophy. He actively involved in installation & commissioning of (RF11) microwave industrial communication system, Fire Alarm system. Presently he is joint secretary, QCFI, Durgapur Chapter.",
  },
  {
    name: "UTPAL SEN",
    picture: "",
    qualifications: "B E (Electrical), Former Dy. General Manager, DSP (SAIL)",
    description:
      "Having a total 39 years of experience in Power management operation & maintenance including Transformer. He is well conversant in all electrical safety related issues. Utpal is an expert trainer in Electrical Safety & actively involved in imparting training at different thermal power plant. He also worked in Indian cable Co & Alstom India",
  },
  {
  ...
  },
  {
    ...
    picture: "",
    qualifications:
      "M Tech( Prod), B E (Mech), Former Chief General Manager, DSP (SAIL)",
    description:
      "With more than 35 years of experience, his main area of works is coal handling plant, water treatment plant, Boiler Turbine maintenance in NTPC – SAIL Power company (NSPCL) Limited. Long time he has served as head of Power Plant of Durgapur Steel Plant having a total of 32 years of experience from stage of commissioning, maintenance & operation of all areas of Power Plant.",
  },
  {
    name: "GOLAM MOWLA",
    picture: "",
